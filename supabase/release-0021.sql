...
--
-- ความหนา และ รหัสสี ของฟิล์ม — เก็บไว้ที่ตัวสินค้าในสต็อก
--
-- รันต่อจาก release-0020.sql
--
-- ปลอดภัยเมื่อรันซ้ำ: add column if not exists
--
...
insert into supabase_migrations.schema_migrations(version, name) values ('0021', 'stock_film_spec') on conflict (version) do nothing;
