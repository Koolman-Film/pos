/*
  การชำระเงิน / แหล่งเงิน / ช่องทางการชำระเงิน — รายการเดียวทุกโมดูล (ร้านขอ 22 ก.ย. 2569)

  "การชำระเงิน/แหล่งเงิน/ช่องทางการชำระเงิน เป็นเรื่องเดียวกัน และต้องเชื่อมโยงกัน
  ทั้งหมด ทุกโมดูล"

  ที่ผ่านมามีสี่รายการแยกกัน — ช่องทางชำระของสาขา (ใบงาน), รายการกลาง
  payment_methods (ขายส่ง, ใช้ร่วมทุกสาขา), รายการกลาง payment_sources
  (ค่าใช้จ่าย) และแหล่งเงิน (การเงิน) — เชื่อมกันด้วยการจับคู่ชื่อตอนคำนวณยอด คำ
  ที่ไม่ตรงกับแหล่งเงินไหน เงินก้อนนั้นก็ไม่เข้าบัญชีไหน

  ตั้งแต่ไฟล์นี้ หน้าจอทุกโมดูลให้เลือกจากแหล่งเงินของสาขานั้นเท่านั้น และเก็บชื่อ
  แหล่งเงินลงในรายการ ชื่อจึงเป็นตัวเชื่อม ไฟล์นี้ทำให้ตัวเชื่อมนั้นเชื่อถือได้:

  1. ชื่อแหล่งเงินห้ามซ้ำในสาขาเดียวกัน — สองบัญชีชื่อเดียวกัน เงินจะเข้าบัญชีแรก
     เสมอ และอีกบัญชีไม่ขยับเลย
  2. เปลี่ยนชื่อแหล่งเงินแล้ว ชื่อเดิมถูกเก็บไว้เป็นชื่อที่ใช้จับคู่อัตโนมัติ —
     รายการที่บันทึกด้วยชื่อเดิมจึงยังนับเข้าบัญชีเดิม
  3. เช็คแยกออกมาเป็นช่องของตัวเอง (order_payments.is_cheque) — เดิมระบบรู้ว่าเป็น
     เช็คจากคำว่า "เช็ค" ในวิธีชำระ พอวิธีชำระกลายเป็นชื่อบัญชีที่เงินจะเข้า
     เช็คจะมองไม่เห็นอีก รายการเก่าที่วิธีชำระมีคำว่าเช็ค ถูกตั้งเป็นเช็คให้

  ไม่แก้จำนวนเงิน วันที่ หรือวิธีชำระของรายการเดิม
*/
