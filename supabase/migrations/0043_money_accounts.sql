-- supabase/migrations/0043_money_accounts.sql
--
...
create index money_accounts_shop_idx on money_accounts (shop_id, sort_order)
  where active;
...
create index money_transfers_shop_idx on money_transfers (shop_id, moved_at desc);
create index money_transfers_from_idx on money_transfers (from_account_id) where from_account_id is not null;
create index money_transfers_to_idx on money_transfers (to_account_id) where to_account_id is not null;
...
create index money_reconciliations_account_idx
